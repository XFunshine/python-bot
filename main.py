...
BOT_TOKEN = "6739339040:AAEDPewhy-3ruEka0d78CrwawFNFA2yEmRI" 😏
PAYMENT_CHANNEL = "@Hackers_warefare" #add payment channel here including the '@' sign
OWNER_ID = 1715422029 #write owner's user id here. get it from @MissRose_Bot by /id
CHANNELS = ["Hackers_warefare"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
